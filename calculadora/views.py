...
def result(request):
    ...
    return render(request,"result.html", {"total_ingreso_mensual" : total_ingreso_mensual, "salud_obligatoria" : salud_obligatoria, "salud_prepagada" : salud_prepagada, "pension_obligatoria" : pension_obligatoria, "aporte_fpv" : aporte_fpv, "compensacion" : compensacion}) 